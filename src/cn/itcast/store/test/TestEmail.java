	...
	public static void main(String[] args) throws Exception {
		...
		Authenticator authenticator = new Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				...
				// 设置发送者的邮箱账户和密码
				return new PasswordAuthentication("m19959556401@163.com", "gg123456g");
		...
		message.setFrom(new InternetAddress("m19959556401@163.com"));
		// 2.2 收件人 , to:收件人 ， cc ：抄送，bcc：暗送（密送）。（模拟账号）
		message.setRecipient(RecipientType.TO, new InternetAddress("479372360@qq.com"));
		// 2.3 主题
